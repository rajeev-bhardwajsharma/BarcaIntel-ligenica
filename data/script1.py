...
OUTPUT_CSV_PATH = "/home/rs/Desktop/football_project/data/barca_filtered_events_luis.csv"
TEAM_NAME = "Barcelona"
NUM_THREADS = 5
...
for comp in competitions:
    if comp["competition_name"] == "La Liga" and comp["season_name"] in ["2014/2015", "2015/2016", "2016/2017"]:
...
with ThreadPoolExecutor(max_workers=NUM_THREADS) as executor:
    results = list(executor.map(thread_wrapper, barca_matches))
